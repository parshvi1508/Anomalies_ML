...
const Navigation = () => {
  ...
  const navItems = [
    ...
    {
      href: '/upload',
      label: 'Data Management, Analytics & Insights',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <nav className="bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 shadow-2xl border-b border-slate-700/50">
