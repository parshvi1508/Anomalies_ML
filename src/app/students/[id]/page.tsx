  ...
  try {
    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className={`rounded-lg border-2 p-6 mb-8 ${riskConfig.color}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <p className={`text-lg font-bold ${riskConfig.textColor}`}>{student.risk_category}</p>
            </div>
            <div>
              <p className="text-sm font-medium text-gray-600">Risk Score</p>
              <p className={`text-lg font-bold ${riskConfig.textColor}`}>{student.risk_score.toFixed(2)}</p>
            </div>
            <div>
        ...
        {/* Student Details */}
        {(student.course || student.email || student.enrollment_date || student.avg_score) && (
                ...
                <span
                  className={`inline-block px-2 py-1 rounded text-xs font-medium ${
                    rec.urgency === 'immediate'
                      ...
                      : rec.urgency === 'within_week'
                      ? 'bg-orange-100 text-orange-800'
                      : rec.urgency === 'within_month'
